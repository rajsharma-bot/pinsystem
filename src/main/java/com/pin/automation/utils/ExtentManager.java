...
public class ExtentManager {
	...
	private static String excelReportPath = ResourceHelper.getResourcePath("src/main/resources/reports/excel-report.xlsx");
	...
	public static ExtentReports getInstance() {
		if (extent == null) {
			reportPath = ResourceHelper.getResourcePath("src/main/resources/reports/extent.html"); // Store path when
																									// creating instance
	...
	public static ExtentReports createInstance(String fileName) {
		...
		extent.setSystemInfo("Environment", EnvConfig.getEnvironment());
